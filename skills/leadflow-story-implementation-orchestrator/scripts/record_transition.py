...
def transition(state_path: Path, story_id: str, target: str, reason: str) -> dict:
    ...
    allowed = {
        ...
        "REVIEWING": {"NEEDS_TECHNICAL_FIX", "CANDIDATE_DONE", "AWAITING_EXTERNAL_REVIEW", "NEEDS_USER_DECISION", "ESCALATED"},
        "AWAITING_EXTERNAL_REVIEW": {"REVIEWING", "NEEDS_TECHNICAL_FIX", "ESCALATED"},
