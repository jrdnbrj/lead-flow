...
import { ArrowLeft, ArrowRight, CarFront, ExternalLink, FileText, Image as ImageIcon, Palette, X } from "lucide-react";
...
function photoSlidesFor(model: CatalogModel): CatalogPhotoSlide[] {
  return [
    { id: `${model.id}-general`, label: "Vista general", imageUrl: model.imageUrl, imageAlt: model.imageAlt },
