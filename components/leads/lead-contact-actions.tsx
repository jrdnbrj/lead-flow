...
export function LeadContactActions({ contact, compact = false, showWhatsApp = true, showShare = true, children }: { contact: VCardContact; compact?: boolean; showWhatsApp?: boolean; showShare?: boolean; children?: ReactNode }) {
