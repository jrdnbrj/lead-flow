...
export function FollowUpActions({
  ...
  return <div className="compact-follow-up mt-2 rounded-xl bg-[#faf9f6] p-2">
    ...
    {actions.length ? <div className="mt-2 space-y-1.5">{actions.map((action) => {
      ...
      return <div key={action.id} className={`rounded-lg border px-2.5 py-2 ${due ? "border-[#f3b257] bg-[#fff8ed]" : "border-black/[0.06] bg-white"}`}>
