-- E3 runtime fix: external effects must preserve the authenticated owner.
-- Migration 023 made external_effects.user_id NOT NULL; keep the request
-- function aligned without modifying the already-deployed historical migration.
